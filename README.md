...
### Processing Methods
- **Text Extraction** (default): Extract text then summarize
- **Direct PDF**: Send PDF directly to Bedrock for native understanding

## 🧪 Exploring Related Labs

This workshop includes additional Bedrock examples in the `completed/` folder:

### RAG (Retrieval-Augmented Generation)
```
completed/rag/
completed/rag_chatbot/
```
Learn how to build knowledge-based systems with embeddings and vector search.

### Chatbots
```
completed/chatbot/
completed/multimodal_chatbot/
```
Interactive conversational AI with context management.

### Embeddings
```
completed/embedding/
completed/embeddings_search/
```
Generate and search semantic embeddings for similarity matching.

### Multimodal Features
```
completed/image/
completed/image_understanding/
completed/image_generation/
```
Work with images: generation, understanding, and manipulation.

### Guardrails
```
completed/guardrails/
```
Implement content filtering, PII detection, and safety controls.
